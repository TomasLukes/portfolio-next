...
const Contacts = (): ReactElement => {
  ...
  return (
    <section
      id="contacts"
      className="max-w-[720px] mx-auto pt-12 md:mt-24 pb-16 md:pb-32"
    >
      ...
      <form
        ...
        className="grid grid-cols-1 gap-2 text-black"
      >
        ...
        <button
          type="submit"
          className="text-neutral-200 mt-4 md:mt-6 m px-6 py-3 bg-neutral-900 rounded-lg border border-neutral-50
