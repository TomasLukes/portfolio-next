...
const ProjectCardLg = ({ name, description, imgHorizontal, imgVertical, url, ghUrl, database}: ProjectCardLgProps): ReactElement => {
  return (
    <article className="flex flex-col lg:flex-row lg:h-[380px] overflow-hidden bg-neutral-900 border border-gray-700 rounded-lg shadow-md">
      <div className="flex flex-col">
        <a href={`${url}`} rel="noreferrer" target="_blank" aria-label={`See live page of ${name}`} className="flex-grow">
          <picture>
              <source media="(max-width: 1022px)" srcSet={`/assets/images/projects-screenshots/${imgHorizontal}`} />
              <source media="(min-width: 1023px)" srcSet={`/assets/images/projects-screenshots/${imgVertical}`} />
              <img
        ...
        <div className="flex-grow">
          <div className="flex mb-4 items-center justify-between gap-8">
            ...
            <div className="flex items-center gap-1 ml-auto">
              ...
              {
                database === "Strapi" ?
                <img className="h-6 w-6" src="/assets/images/icons/tech/strapi.png" alt="Strapi icon" /> :
