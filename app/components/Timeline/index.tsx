  ...
  return (
    <ol id="timeline" className="h-full border-l-4 border-neutral-200 ">
      <li className="pl-8 pb-4 pt-6 relative">
        <img src="/assets/images/icons/jobs/akcenta.png" 
          className="absolute top-6 left-[-2px] w-8 h-8 rounded-full transform -translate-x-1/2" alt="" />
      ...
      <img src="/assets/images/icons/jobs/CT.png" 
          className="absolute left-[-2px] w-8 h-8 rounded-full transform -translate-x-1/2" alt="" />
